...
public class BySalaryRangeController {
    ...
    private void handleSearch() {
        String l = lowest.getText();
        String h = highest.getText();
        String regex = "^-?\\d+$";
        if (l.matches(regex) && h.matches(regex)) {
            ...
            ArrayList<player> players = database.search_salary(Integer.parseInt(l),Integer.parseInt(h));
